...
def gtsrb_data(base, listfile_tr, listfile_tr_gt, listfile_te, listfile_te_gt, listfile_temp, transform=None, split=100, should_invert=False):
    ...
    train_dataset = ListDataset(train_list, temp_list, transform, should_invert)
    test_dataset = ListDataset(test_list, temp_list, transform, should_invert)
